...
namespace Ladybug_Mayhem
{
    public class DrawBG
    {
...

        {
            ...
            textures[0] = new DrawObject(game, content, "Roof North West", 1, new Vector2(baseXPos, baseYPos-(checkTexture.Bounds.Height / 2)), 0.9f);
            ...
            textures[3] = new DrawObject(game, content, "Roof West", 1, new Vector2(baseXPos, textures[1].GetPosition().Y + textures[1].GetSprite().Bounds.Height - 87), 0.9f);
            textures[4] = new DrawObject(game, content, "Brown Block", 4, new Vector2(baseXPos + textures[3].GetSprite().Bounds.Width, textures[3].GetPosition().Y), 0.9f);
            ...
            textures[7] = new DrawObject(game, content, "Roof South West", 1, new Vector2(baseXPos, textures[3].GetPosition().Y + (textures[3].GetSprite().Bounds.Height / 2)), 0.9f);
            textures[8] = new DrawObject(game, content, "Roof South", 4, new Vector2(baseXPos + textures[7].GetSprite().Bounds.Width, textures[7].GetPosition().Y), 0.9f);
            ...
            textures[10] = new DrawObject(game, content, "Roof South East", 1, new Vector2(textures[9].GetPosition().X + textures[9].GetSprite().Bounds.Width, textures[7].GetPosition().Y), 0.9f);
